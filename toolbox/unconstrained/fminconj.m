%==========================================================================
%
% fminconj  Finds the local minimizer and minimum of an objective 
% function using the conjugate gradient descent method.
%
%   x_min = fminconj(f,x0)
%   x_min = fminconj(f,x0,opts)
%   [x_min,f_min] = fminconj(__)
%   [x_min,f_min,k] = fminconj(__)
%   [x_min,f_min,k,x_all,f_all] = fminconj(__)
%
% Author: Tamas Kis
...
%
%==========================================================================
function [x_min,f_min,k,x_all,f_all] = fminconj(f,x0,opts)
